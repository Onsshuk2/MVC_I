...
namespace pv311_mvc_project.Services.Cart
{
    public class CartService : ICartService
    {
        ...
        public async Task<bool> ApplyPromoCodeAsync(string promoCode)
        {
            // Реалізація застосування промокоду (наприклад, перевірка в базі даних)
        ...
        Task<decimal> ICartService.ApplyPromoCodeAsync(string promoCode)
        {
